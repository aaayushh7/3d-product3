...
//                 </div>
//                 <div className='flex'>
//                 {/* <button className='fixed bottom-8 right-[350px] px-7 py-3 shadow-md items-center justify-center bg-[#5f80ea] rounded-md cursor-pointer '>View in AR web</button> */}
//                 <button onClick={()=>{
...
//                 }}className='fixed bottom-8 right-[350px] px-7 py-3 shadow-md items-center justify-center bg-[#5f80ea] rounded-md cursor-pointer '>View in AR web</button>
        ...
        <div className='h-screen w-screen flex items-center'>
            ...
            <div className='w-25%'>
                ...
                <div className=" h-1 w-[350px] bg-gray-200 rounded-sm">
                    <div className=" left-0 h-1 bottom-9 bg-blue-500 rounded-sm " style={{ width: '90%' }}></div>
                    <h1 className='text-[22px] text-center mt-3'>Great! 4+ years.</h1>
                </div></div>
                <div className='flex'>
